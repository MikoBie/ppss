...
\begin{frame}
    ...
    \only<+>{
        ...
        \begin{center}
            \includegraphics[height = .9\textheight]{gww.jpg}
        \end{center}
    }
    \only<+>{
        \framesubtitle{Current Book}
        \begin{center}
            \includegraphics[height = .9\textheight]{flashlight.jpg}
        \end{center}
    }
    \only<+>{
        \framesubtitle{Current Comics Books}
        \begin{minipage}{.49\textwidth}
            \begin{center}
                \includegraphics[height = .9\textheight]{zerocalcare.jpg}
            \end{center}
        \end{minipage}
        \begin{minipage}{.49\textwidth}
            \begin{center}
                \includegraphics[height = .9\textheight]{zerocalcare2.jpg}
            \end{center}
        \end{minipage}
    }
\end{frame}
...
\begin{frame}
    ...
    \only<2>{
        \begin{center}
            \includegraphics[height = .9\textheight]{pretty_please.jpg}
        \end{center}
    }
\end{frame}
...
\begin{frame}
    ...
    \only<1>{
        \begin{center}
            \includegraphics<1>[height = .9\textheight]{copy_paste.png}
        \end{center}
    }
    \only<2>{
        \begin{center}
            \includegraphics<2>[height = .9\textheight]{stack_overflow.png}
        \end{center}
    }
    \only<3>{
        \begin{itemize}
    ...
    \only<4>{
        \begin{center}
            \includegraphics<4>[height=.9\textheight]{chatgpt_stackoverflow.png}
        \end{center}
    }
    \only<5>{
        \begin{center}
            \includegraphics<5>[height=.9\textheight]{chatgpt.png}
        \end{center}
    }
    \only<6>{
        \begin{center}
            \includegraphics<6>[height = .9\textheight]{chatgpt_meme_original.jpg}
        \end{center}
    }
    \only<7>{
        \begin{center}
            \includegraphics<7>[height=.9\textheight]{chatgpt_meme.jpg}
        \end{center}
    }
    \only<8>{
        \begin{center}
            \includegraphics<8>[height=.9\textheight]{chatgpt2026.png}
        \end{center}
    }
...
\begin{frame}
    \only<+>{
        \centering
        \includegraphics[height = .9\textheight]{png/jupyter.png}
    }
    \only<+>{
    ...
    \only<+>{
        ...
        \centering
        \includegraphics[width = .7\textwidth]{png/jupyter_notebook.png}
    }
    \only<+>{
...
\begin{frame}
    \only<+>{
        \begin{center}
            \includegraphics[height = .6\textheight]{png/colab.png}
        \end{center}
    }
    \only<+>{
    ...
    \only<+>{
        ...
        \centering
        \includegraphics[width = .7\framewidth]{png/colaboratory.png}
    }
    \only<+>{
    ...
    \only<+>{
        \frametitle{How to open Jupyter Notebook in Colaboratory?}
        \centering
        \includegraphics[width = .8\framewidth]{png/colab_notebook.png}
    }
\end{frame}
